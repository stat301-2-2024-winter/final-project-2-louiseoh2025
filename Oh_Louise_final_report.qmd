...
-   Elastic Net: Lasso Regression (glmnet engine):
    ...
    -   The penalty was tuned but not updated and explored over with 5 levels.
...
-   Boosted Tree (xgboost engine):
    ...
    -   The number of randomly selected predictors to split on was explored over \[2, 25\] with 5 level s, since there were 43 predictors used in my recipe.
    -   The minimum number of data points in a node for splitting was explored over \[2, 25\] with 5 levels.
    -   The learning rate was tuned but not updated.

-   Random Forest (ranger engine):

    -   The number of trees was set to 1000, a standard number for tree-based models.
    -   The number of randomly selected predictors to split on was explored over \[2, 25\] with 5 levels.
    -   The minimum number of data points in a node for splitting was explored over \[2, 25\] with 5 levels.
...
It is easier to view the best hyperparameters by RMSE for comparison on each of the objects containing the tuning information. @tbl-parameters shows the best hyperparameters of each model adjusted to and used to fit the data for both recipes.
